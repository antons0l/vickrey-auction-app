  ...
  return (
    <>
      <div className="text-center">
        ...
        <button
          className={`bg-[#1c4c84] disabled:bg-gray-500 px-6 py-1 text-white rounded-lg shadow-md focus:outline-none transition-transform hover:scale-105 disabled:hover:scale-100`}
          ...
          {auctions?.length > 0 ? (
            auctions.map((auction) => (
              <AuctionCard
                ...
                endAt={auction?.endAt}
                winner={auction?.winner_user_name}
                winAmount={auction?.winning_amount}
              ></AuctionCard>
            ))
          ) : (
